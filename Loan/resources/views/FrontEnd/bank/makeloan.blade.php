                        ...
                        <form method="POST">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group py-3">
                                    ...
                                    <input type="text" class="form-control" id="loanID" maxlength="8"
                                        placeholder="#1102030" name="loanID" readonly required>
                                </div>
                                ...
                                <div class="form-group py-3">
                                    ...
                                    <input type="number" class="form-control" id="amount" min="0" step="0.01"
                                        placeholder="Principle Amount" name="amount" required>
                                </div>
                                <div class="form-group py-3">
                                ...
                                <div class="form-inline justify-content-center">
                                    ...
                                    <div class="form-group col-md-4" style="margin-left: 10px;">
                                        <select style="width:150px;" id="schedule" name="schedule" class="form-control"
                                ...
                                <div class="form-inline justify-content-center">
                                    <div class="form-group col-md-4">
                                        ...
                                        <select style="width:206px" id="duration" name="duration" class="form-control"
                                            required>
                                            <option selected>Choose..</option>
                                    ...
                                    <div style="display:flex; justify-content: space-evenly">-</div>
                                    <div class="form-group col-md-4" style="margin-left: 10px;">
                                        <select style="width:150px;" id="duration" name="duration" class="form-control"
                                ...
                                <div class="form-row d-flex justify-content-center">
                                    ...
                                    <div class="form-group col-md-4" style="margin-left: 10px;">
                                        <select style="width:150px;" id="repayCycle" name="repayCycle"
                                ...
                                <div class="form-row d-flex justify-content-center">
                                    ...
                                    <div class="form-group col-md-4" style="margin-left: 10px;">
                                        <input type="number" min="1" max="100" id="numofRepayment"
                                            name="numofRepayment" required>
                                    </div>
                                </div>
